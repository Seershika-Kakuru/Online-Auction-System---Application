...
ResultSet rs = stmt.executeQuery("select a.itemID, e.name, a.HighestBid from auction a, electronicdevices e where a.itemID = e.eID and a.HighestBid >= a.hiddenMinimumPrice and a.closingDate < now() order by a.HighestBid DESC LIMIT 3");
%>
<style>
table, th, td {
