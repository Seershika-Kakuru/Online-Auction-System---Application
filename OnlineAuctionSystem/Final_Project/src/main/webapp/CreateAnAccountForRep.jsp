...
<form name="myForm" action="InsertInformationForRep.jsp" method="POST">
       <table  style="border:3px; border-style:solid; border-color:#00008B; padding: 1em; position:relative; left:150px">
       <tr>
       <td style="font-size:16pt;"><b>Enter the MemberID: </b></td><td><input type="text" name="MemberID" maxlength="100" size = "50" style="font-size:16pt;"/></td>
